...
- [RL62M02 藍牙 Mesh AT 指令程式設計指南](#rl62m02-藍牙-mesh-at-指令程式設計指南)
  ...
  - [資料傳輸指令](#資料傳輸指令)
    ...
    - [GATT 透傳服務發送數據](#gatt-透傳服務發送數據)
  - [BLE Mesh DataTrans service](#ble-mesh-datatrans-service)
    - [Characteristic UUID Properties](#characteristic-uuid-properties)
...
AT+COMMAND {<param>…}\r\n
- 指令開頭都是 AT， 並以”\r\n”為結束
- 如果指令需要設置參數, 相關參數都必須放於(space)之後
- 指令執行成功將回覆”SUCCESS”， 失敗則回覆”ERROR”，並且不會有參數<param>

### 回傳指令格式
INDICATION {<param>…}\r\n
- 回傳指令都會以”\r\n”為結尾，且開頭會有(INDICATION)-MSG 識別碼
- 如果回傳指令有包含參數, 參數都會於(space)之後
...
## BLE Mesh DataTrans service
UUID = 524CACC0-3C17-D293-8E48-14FE2E4DA212
### Characteristic UUID Properties
RX -> 0000D001-0000-1000-8000-00805F9B34FB Write, Write No Response
TX -> 0000D002-0000-1000-8000-00805F9B34FB Notify